  ...
  return (
    <section className="pricing" ref={sectionRef}>
      ...
      <div className="pricing__header">
        <div className="pricing__label">Service Packages</div>
        <h2 className="pricing__heading">What do you need?</h2>
        <p className="pricing__subtext">
          From free inspections to full roof replacements — we handle all roof types across
          all five NYC boroughs, Yonkers, and Westchester County. Every job starts with a
          written estimate and an honest recommendation.
        </p>
      </div>
