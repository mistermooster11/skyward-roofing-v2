          ...
          <div className="contact-section__details">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                New York City, NY (serving all 5 boroughs + Westchester)
              </p>
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                <Link href="tel:+19179798704">(917) 979-8704</Link>
              </p>

              <h5 className="contact-detail__label">Email</h5>
              <p className="contact-detail__value">
                <Link href="mailto:info@skywardroofing.com">info@skywardroofing.com</Link>
              </p>
            </div>
