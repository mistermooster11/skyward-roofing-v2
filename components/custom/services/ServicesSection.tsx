    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Expert Roofing Services Across All Five NYC Boroughs
        </h2>
        <p className="services__subtext">
          Residential and commercial roofing for every roof type — flat, shingle, metal, slate,
          and tile. Free in-person inspections, written estimates, and honest recommendations
          across NYC and Westchester County.
        </p>
      </div>
