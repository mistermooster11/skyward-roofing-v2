      ...
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          ...
          <p className="testimonials__subtext">
            NYC property owners trust Skyward Roofing for honest assessments, quality work,
            and a third-generation team that shows up, delivers, and stands behind every job.
          </p>
        </div>
