  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>Skyward Roofing</strong> is a third-generation, family-owned roofing company
            serving all five NYC boroughs, Yonkers, and Westchester County. Licensed, bonded,
            and insured — with free inspections and honest assessments on every job.
          </p>
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 Skyward Roofing. All rights reserved.</p>
