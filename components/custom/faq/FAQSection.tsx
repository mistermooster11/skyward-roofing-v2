      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About NYC Roofing
          </h2>
          <p className="faq__subtext">
            Answers about repair vs. replacement, free inspections, licensing, service areas,
            roof types, and what to expect when you call Skyward Roofing.
          </p>
